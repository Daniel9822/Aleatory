...
const makeMessagesRecvSocket = (config) => {
    ...
    const processMessageLocal = async (message) => {
        ...
        const isAnyHistoryMsg = !!message.message && !!((_b = (_a = (0, Utils_1.normalizeMessageContent)(message.message)) === null || _a === void 0 ? void 0 : _a.protocolMessage) === null || _b === void 0 ? void 0 : _b.historySyncNotification);
        if (isAnyHistoryMsg) {
            await sendNode({
                tag: 'receipt',
                attrs: {
        ...
        const newEvents = await (0, process_message_1.default)(message, { historyCache, meId, keyStore: authState.keys, logger, treatCiphertextMessagesAsReal });
        if (isAnyHistoryMsg) {
