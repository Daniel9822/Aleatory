...
const makeMessagesRecvSocket = (config) => {
    ...
    const processMessage = async (message, chatUpdate) => {
        ...
        if (protocolMsg) {
            ...
            ev.emit('messages.reaction', { reaction, key: content.reactionMessage.key, operation });
        }
    ...
    const handleUpsertedMessages = async ({ messages, type }) => {
        ...
        if (type === 'notify' || type === 'append') {
            const chatId = (0, WABinary_1.jidNormalizedUser)(messages[0].key.remoteJid);
            ...
            for (const msg of messages) {
                ...
                if ((!!normalizedContent ||
                    (msg.messageStubType === Types_1.WAMessageStubType.CIPHERTEXT && treatCiphertextMessagesAsReal))
