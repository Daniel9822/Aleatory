...
declare const makeLegacySocket: (config: Partial<LegacySocketConfig>) => {
    ...
    productCreate: (product: import("@adiwajshing/baileys/src/Types/Product").ProductCreate) => Promise<import("@adiwajshing/baileys/src/Types/Product").Product>;
    productDelete: (productIds: string[]) => Promise<{
        deleted: any;
    }>;
    productUpdate: (productId: string, update: import("@adiwajshing/baileys/src/Types/Product").ProductUpdate) => Promise<import("@adiwajshing/baileys/src/Types/Product").Product>;
